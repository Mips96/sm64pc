...
#### My personal development fork for sm64ex/sm64pc. My code changes and patch files can be found in Pull Requests. The readme for the original repo is below:
